...
\usepackage{titlesec}
\usepackage{enumitem}
\setlist[enumerate]{label=（\arabic*）, itemsep=0pt, parsep=0pt, topsep=2pt, partopsep=0pt}
...
% 设置字体（统一使用 fonts/ 目录）
\setCJKmainfont{simsun.ttc}[Path=fonts/, AutoFakeBold=3, BoldFont=simhei.ttf, Mapping=fullwidth-stop]
\setCJKsansfont{simhei.ttf}[Path=fonts/, AutoFakeBold=3, Mapping=fullwidth-stop]
\setCJKmonofont{simsun.ttc}[Path=fonts/, Mapping=fullwidth-stop]
\setCJKfamilyfont{heiti}{simhei.ttf}[Path=fonts/, AutoFakeBold=2, Mapping=fullwidth-stop]
\setCJKfamilyfont{songbold}{simsun.ttc}[Path=fonts/, AutoFakeBold=2, Mapping=fullwidth-stop]
\setCJKfamilyfont{zhfs}{fangsong.ttf}[Path=fonts/, Mapping=fullwidth-stop]
