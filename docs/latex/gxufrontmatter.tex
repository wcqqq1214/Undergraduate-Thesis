...
\begin{tikzpicture}[remember picture, overlay, transform canvas={yshift=-10.5pt}]
    ...
    \node[anchor=south, opacity=1] at
        ...
        {\includegraphics[width=5.7cm]{gxu_name.png}};
    \fi
...
\begin{tabular}{@{}r@{\hspace{1em}}l@{}}
    ...
    \ifdefempty{\classname}{}{%
    \zihao{-3}\bfseries 班级：&
    \zihao{-3}\underline{\makebox[11em][c]{\classname}} \\[10.2pt]}
    \ifdefempty{\id}{}{%
    \zihao{-3}\bfseries 学号：&
    \zihao{-3}\underline{\makebox[11em][c]{\id}} \\[10.2pt]}
    \ifdefempty{\thesisauthor}{}{%
    \zihao{-3}\bfseries 姓名：&
    \zihao{-3}\underline{\makebox[11em][c]{\thesisauthor}} \\[10.2pt]}
    \ifdefempty{\supervisor}{}{%
    \zihao{-3}\bfseries 指导老师：&
